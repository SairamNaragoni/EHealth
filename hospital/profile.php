                ...
                <section class="panel">
                    <div class="panel-body" style="margin: auto;text-align: center;">
                        ...
                        ?>
                            ...
                            <li><a>Name : <?php echo $row['hname']?></a></li>
                            <li><a><?php echo $row['hmail']?></a></li>
                            <li><a><i class="fa fa-volume-control-phone" ></i>: +91<?php echo $row['hphone']?></a></li>
                ...
                <section class="panel">
                    ...
                    <div class="panel-body minimal">
                        ...
                        <tr class="">
                            ...
                            <td class="view-message view-message"><?php echo $row['haddr']?></td>
                        </tr>
                        <tr class="">
                            <td class="inbox-small-cells"></i></td>
